...
<head>
  ...
  <!-- Vendor CSS Files -->
  <link href="../Backend/../Backend/assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
      ...
      <div class="header-container d-flex align-items-center" style="background-color:#53c68c;">
        ...
        <nav class="nav-menu" style="background-color:#53c68c;">
          <ul style="background-color:#53c68c;">
            ...
            <li class="get-started" style="margin-left:100px;"><a href="sign_up_Customer.php">Customer </br> <center>Menu</center></a></li>
            <li class="get-started"><a href="sign_up_Merchant.php">Business Owner</br> <center>Menu</center></a></li>
          </ul>
        </nav><!-- .nav-menu -->
...
Luisa Martinez
  ...
  <div class="col-lg-6" data-aos="fade-right" data-aos-delay="100" style="position:absolute; right:740px; top:698px;">
            ...
            <img src="../images/air_jordan_ad.jpg" style="width:700px; height:400px; ">
